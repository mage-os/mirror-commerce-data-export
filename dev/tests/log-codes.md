...
| CDE03-22 | warning  | `CDE03-22 StagedCategoryUrlKeyChangeDetector: no active row at version {version_id} for entity_id(s) [{entity_ids}]; skipping.`  | `commerce-data-export-ee/CatalogStagingDataExporter/Model/Category/StagedCategoryUrlKeyChangeDetector.php`           |
| CDE03-23 | error    | `CDE03-23 StagedCategoryUrlKeyChangeDetector: catalog_category url_key attribute not found; failing open.`                       | `commerce-data-export-ee/CatalogStagingDataExporter/Model/Category/StagedCategoryUrlKeyChangeDetector.php`           |
| CDE03-24 | error    | `CDE03-24 InvalidateProductFeedOnCategoryUrlKeyChange: scheduler failed for path "{path}": {error_message}`                      | `commerce-data-export-ee/CatalogStagingDataExporter/Plugin/Category/InvalidateProductFeedOnCategoryUrlKeyChange.php` |
| CDE03-25 | error    | `CDE03-25 InvalidateProductFeedOnCategoryUrlKeyChange: gate query failed: {error_message}`                                       | `commerce-data-export-ee/CatalogStagingDataExporter/Plugin/Category/InvalidateProductFeedOnCategoryUrlKeyChange.php` |
| CDE03-26 | error    | `CDE03-26 InvalidateProductFeedOnCategoryUrlKeyChange: unable to expand staged url_key category reindex scope: {error_message}`            | `commerce-data-export-ee/CatalogStagingDataExporter/Plugin/Category/InvalidateProductFeedOnCategoryUrlKeyChange.php` |
...
| CDE03-28 | warning  | `CDE03-28 StagedCategoryUrlKeyChangeDetector: catalog category staging schema is not present; skipping staged url_key change detection.` | `commerce-data-export-ee/CatalogStagingDataExporter/Model/Category/StagedCategoryUrlKeyChangeDetector.php`           |
