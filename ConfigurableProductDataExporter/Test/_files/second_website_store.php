...
$store->setCode('cde_third_store')
    ->setWebsiteId($website->getId())
    ->setGroupId($storeGroup->getId())
    ->setName('CDE Third Store')
    ->setSortOrder(20)
    ->setIsActive(1);
