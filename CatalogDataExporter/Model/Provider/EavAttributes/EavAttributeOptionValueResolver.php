...
/**
 * Resolves EAV attribute option ids to their store-specific labels for a given entity type.
 *
 * Entity-agnostic: the concrete entity table (catalog_product_entity / catalog_category_entity)
 * is provided via constructor so the same logic can serve products and categories.
 */
class EavAttributeOptionValueResolver
{
    /**
     * @var array|null
     */
    ...
    public function __construct(
        ...
        string $entityTable = 'catalog_product_entity'
    ) {
    ...
    private function getAttributesSelect(string $attributeCode): Select
    {
        ...
        return $connection->select()
            ...
            ->where('t.entity_table = ?', $this->entityTable)
